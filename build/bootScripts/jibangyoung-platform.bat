...
set JARPATH=%APP_HOME%\lib\jibangyoung-platform.jar

@rem Execute jibangyoung-platform
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %JIBANGYOUNG_PLATFORM_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%JIBANGYOUNG_PLATFORM_EXIT_CONSOLE%" exit 1
exit /b 1
